namespace alchemist {
    ...
    class GameState {
        ...
        public bool Clarahelped { get; set; } = false;
        public bool Clarahelpedgift { get; set; } = false;
    ...
    internal class Program {
        ...
        static void NewGame() {
            ...
            string Newchoise = Console.ReadLine().ToLower();
            if (Newchoise == "yes") {
        ...
        static void shop(GameState g) {
            ...
            while (true) {
                ...
                switch (shopwyb) {
                    ...
                    case 4:
                        if (g.Claramad == true) {
                            Console.WriteLine("Clara glares at you, she dosnt talk to you. Just looks at igridients and wait for you to leave");
                            break;
                        } else { talk1(g); }
                        break;
                    case 5:
        ...
        static void sleep(GameState g) {
            ...
            g.Day += 1;
            int Clarahelp = rnd.Next(1, 11);
            if (Clarahelp < 10 && g.Clarahelped == false) {
